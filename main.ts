...
scene.onOverlapTile(SpriteKind.Player, assets.tile`tile`, function (sprite, location) {
    tiles.placeOnRandomTile(hero, assets.tile`tile13`)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`tile12`, function (sprite, location) {
    tiles.placeOnRandomTile(hero, assets.tile`tile14`)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`tile15`, function (sprite, location) {
    tiles.placeOnRandomTile(hero, assets.tile`tile11`)
})
